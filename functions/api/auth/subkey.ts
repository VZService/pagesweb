...
// 仅主 KEY 可操作。
import { Ctx, fail, ok, preflight, readJson, readKey, isBrowserOrigin, clampString } from "../../../src/_util.ts";
import { authByKey, issueSubkey, listSubkeys, revokeSubkey, audit } from "../../../src/_auth.ts";
